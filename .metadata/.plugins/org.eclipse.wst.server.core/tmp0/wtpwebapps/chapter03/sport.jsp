...
<body>
	...
	<form action="sport" method="post">
		<fieldset>
			...
			<div>
				<label for="baseball">야구</label> <input type="checkbox"
					name="sports" value="야구" /> <label for="football">축구</label> <input
					type="checkbox" name="sports" value="축구" /> <label
					for="basketball">농구</label> <input type="checkbox" name="sports"
					value="농구" />
			</div>
			<div>
				<label for="sex">남</label> <input type="radio" name="sex" value="남자" />
